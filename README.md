...
```
```text
Цель работы: Изучить добавление, организацию и обслуживание статических файлов
в веб-приложении на платформе ASP.NET Core.
```
...
Демонстрирует работу со статическими файлами в ASP.NET Core.
